...
public class TestBase {
	...
	public TestBase(){
		...
		try {
			FileInputStream fileip = new FileInputStream("C:/Users/Administrator/eclipse-workspace/SeleniumTestProject/src/main/java/com/eg/qa/config/config.properties");
			prop.load(fileip);
